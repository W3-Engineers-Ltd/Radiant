...
Quickstart will show you how to quickly create and run a Radiant
application, how to modify code, and explain how the MVC system works.
Let’s get started!

-  `Creating a new project with the radical tool <new.html>`__
-  `Configure routers <router.html>`__
-  `Creating controllers <controller.html>`__
-  `Creating models <model.html>`__
-  `Creating views <view.html>`__
-  `Handling static files <static.html>`__
