...
Install the latest radical tool
``go get -u github.com/W3-Engineers-Ltd/Radical`` Upgrading Radiant
...
1. ``AddFilter`` method was removed, and you could update your code
   from：
...
2. radiant.AfterStatic was removed，please using radiant.BeforeRouter
