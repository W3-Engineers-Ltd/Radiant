...
We use often pagination in templates. How do we do that? We have created
this demo for pagination. We hope it’s useful to you.

Controllers
-----------

Before you can use the paginator in the view you have to set it in your
controller:
