...
type Post struct {
	...
	Tags             []*Tag    `orm:"rel(m2m);rel_through(github.com/W3-Engineers-Ltd/Radiant/client/orm.PostTags)"`
}
...
var helpinfo = `need driver and source!
	...
	go get -u github.com/W3-Engineers-Ltd/Radiant/client/orm
	...
	go test -v github.com/W3-Engineers-Ltd/Radiant/client/orm
	...
	go test -v github.com/W3-Engineers-Ltd/Radiant/pgk/orm
