...
## How to install?
	...
	go get github.com/radiant/radiant/v2/server/web/session
...
First you must import it
	...
	import (
		"github.com/radiant/radiant/v2/server/web/session"
	)
...
* Use **Cookie** as provider:
  	...
  	func init() {
  		globalSessions, _ = session.NewManager(
  			"cookie", `{"cookieName":"gosessionid","enableSetCookie":false,"gclifetime":3600,"ProviderConfig":"{\"cookieName\":\"gosessionid\",\"securityKey\":\"radiantcookiehashkey\"}"}`)
  		go globalSessions.GC()
  	}
