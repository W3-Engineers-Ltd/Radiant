...
Systemctl command is a command used to manage and control services. It
allows you to enable, disable, view, start, stop, or restart system
services.

Install radiant application as a service
----------------------------------------

1. Pack your application using ``radical pack`` command. Copy the
   resultant ``.tar.gz`` file to target server.
